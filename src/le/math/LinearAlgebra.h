...
#ifndef PROJECT_LINEARALGEBRA_H
#define PROJECT_LINEARALGEBRA_H
...
namespace le { namespace math {
        ...
        public:
            ...
            */
             ...
             */
            template<class T>
             static std::pair<typename EigenMatrix<T>::type,
             typename EigenVector<T>::type >
