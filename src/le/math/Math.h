//
// Created by Sail Yang on 2019-09-13.
//
...
namespace le { namespace math {
        ...
        */
        ...
        public:
             ...
             * @return The clamped values
             */
            static le::math::Q clampQ(const rw::math::Q& q,
             ...
             * @return The clamped values
             */
            static le::math::Vector3D<> clamp(
                    const le::math::Vector3D<>& q,
                    const le::math::Vector3D<>& min,
                    const le::math::Vector3D<>& max)
            {
                assert(q.size() == min.size());
                assert(q.size() == max.size());
             ...
             */
            static le::math::Q ranDir(size_t dim, double length = 1)
            {
                Q q(dim);
